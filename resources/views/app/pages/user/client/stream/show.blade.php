                    ...
                    <tr>
                        ...
                        <td class="col-xs-3 text-center">
                            @if ($b->getOriginal('pivot_status') == 'waiting' && $isFinished)
                                <a href="/user/client/stream/{{ $stream->id }}/{{ $b->id }}/accept" class="btn-white"><i class="fa fa-plus-circle"></i> accept</a>
                                <a href="/user/client/stream/{{ $stream->id }}/{{ $b->id }}/decline" class="btn-white"><i class="fa fa-minus-circle"></i> decline</a>
                            @endif
                        </td>
                    </tr>
                @empty
